...
export function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      // Toggle the isScrolled state when we've scrolled down a certain amount (e.g., 50px)
    ...
    // Call it initially just in case we load the page already scrolled
    handleScroll();
    ...
    >
      <div className="mx-auto flex items-center justify-between relative w-full pr-0 md:px-4 lg:px-8">
        ...
        <div className="flex items-center gap-[2px] md:gap-2 flex-1 justify-end relative">
          ...
          <div
            className={`hidden md:flex items-center border-b border-current overflow-visible transition-all duration-300 ease-in-out relative ${
              isSearchOpen
                ? "w-64 opacity-100"
          ...
          >
            <input
              ...
              type="text"
              placeholder="Search..."
              className="bg-transparent outline-none w-full text-sm py-1 px-2 placeholder:text-current placeholder:opacity-70"
              value={searchQuery}
                  ...
                  {searchSuggestions.map((product) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 min-w-0">
                        <span className="text-xs font-bold text-black truncate w-full">
                          {product.name}
                        </span>
                ...
                >
                  ...
                  <div className="p-2 flex flex-col gap-1">
                    <Link
                      ...
                      className="flex items-center gap-3 px-4 py-2.5 text-sm font-bold text-neutral-600 hover:text-black hover:bg-neutral-50 rounded-lg transition-all"
                    >
                  ...
                  <div className="p-2 border-t border-neutral-100">
                    <button
                      onClick={() => setIsProfileOpen(false)}
                      className="w-full flex items-center justify-between px-4 py-2.5 text-sm font-bold text-red-600 hover:bg-red-50 rounded-lg transition-all"
                    >
          ...
          >
            ...
            {cartItems.length > 0 && (
              <span
                className={`absolute -top-2 -right-2 text-[10px] font-bold h-4 w-4 rounded-full flex items-center justify-center transition-colors ${
      ...
      {/* Mobile / Half-Screen Menu Drawer */}
      <AnimatePresence>
        {isMobileMenuOpen && (
          <>
            {/* Backdrop overlay */}
            ...
            >
              ...
              <div className="relative flex items-center justify-between p-6 border-b border-neutral-100 min-h-[80px] bg-white">
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                  className="p-2 hover:bg-neutral-100 rounded-full transition-colors -ml-2 z-10"
                  ...
                  >
                    ...
                    >
                      ...
                      <span className="text-neutral-300 group-hover:text-black transition-colors duration-300">
                        <ChevronDown
                          className={`w-6 h-6 transition-transform duration-300 ${isMobileCategoriesOpen ? "rotate-180" : ""}`}
                        />
                      </span>
                    </button>
                  ...
                  {searchSuggestions.map((product) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col flex-1 pt-1 min-w-0">
                        <span className="text-base font-bold text-black uppercase tracking-tight group-hover:text-neutral-500 transition-colors truncate">
                          {product.name}
                        </span>
          ...
          >
            <div className="flex items-center justify-between p-6 border-b border-neutral-100 min-h-[80px] bg-neutral-50/50">
              ...
              <button
                ...
                className="p-2 hover:bg-neutral-200 rounded-full transition-colors -mr-2"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            <div className="flex-1 overflow-y-auto px-6 py-6 flex flex-col gap-4 bg-white">
              <Link
                href="/account/orders"
                onClick={() => setIsMobileProfileOpen(false)}
                className="flex items-center gap-4 px-4 py-5 text-xl font-bold text-neutral-700 hover:bg-neutral-100 rounded-xl transition-all"
              >
            ...
            <div className="p-6 border-t border-neutral-100 mt-auto bg-white">
              <button
                onClick={() => setIsMobileProfileOpen(false)}
                className="w-full flex items-center justify-between px-6 py-5 text-xl font-bold text-red-600 bg-red-50 hover:bg-red-100 rounded-xl transition-all"
              >
