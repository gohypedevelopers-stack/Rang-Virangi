...
const INITIAL_WISHLIST =
  products.length >= 2 ? [products[0], products[1]] : products;
      ...
      {wishlist.length === 0 ? (
        <div className="text-center py-20 border-2 border-dashed border-neutral-200 rounded-2xl">
          ...
          <p className="text-neutral-500 mb-6 font-medium">
            Discover your next favorite piece from our latest collection.
          </p>
          <Link
            href="/shop"
            className="bg-black text-white px-8 py-3 rounded-xl font-bold uppercase tracking-widest text-xs hover:bg-neutral-800 transition-colors shadow-lg shadow-black/10 inline-block"
          >
            Start Shopping
          </Link>
        </div>
